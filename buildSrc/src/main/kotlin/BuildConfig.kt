object BuildConfig {
    ...
    val modVersion: String = "1.2.6+" + minecraftVersion
    ...
    val everyCompatVersion: String = "1.21-2.11.41"
    val macuLibVersion: String = "2.0.2"
    val modmenuVersion: String = "11.0.3"
    val reiVersion: String = "16.0.799"

    val naturesSpiritVersionNeoforge: String = "MGjl80vc"
    val naturesSpiritVersionFabric: String = "TRMapjpU"
